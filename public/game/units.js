...
export const UNITS = Object.freeze({
  ...
  tigger:{id:'tigger',mass:1.8,name:'穴掘りティガー',short:'ティガー',role:'奇襲・地下移動',cost:3,hp:1100,damage:15,speed:56,range:30,cooldown:.82,radius:16,count:1,air:false,targetsAir:false,tunnelAnywhere:true,burrowMin:.9,burrowMax:2.8,burrowBase:.55,burrowSpeedDivisor:380,color:'#c08a52',desc:'戦場の好きな地上地点を指定し、自軍中央本拠地から地下を掘って移動する奇襲兵。攻撃は15と低いが、潜行中は完全に攻撃対象外。地下移動はv15でやや遅くなり、遠い地点ほど到着に時間がかかる。'},
  muddragon:{id:'muddragon',mass:4.8,name:'マッドドラゴン',short:'泥竜',role:'空中範囲・泥沼制圧',cost:5,hp:2000,damage:200,speed:36,range:78,cooldown:1.6,radius:22,count:1,air:true,targetsAir:true,projectile:'mud',splash:45,mudRadius:45,mudDuration:2,mudTickEvery:.5,mudDamage:30,mudSlow:.70,color:'#8b7657',desc:'少し遅い飛行ドラゴン。v15で射程を約半分の78へ短縮。地上・空中へ半径45の範囲攻撃を行い、着弾地点に2秒間の泥沼を残す。泥沼は地上兵だけに30ダメージの継続攻撃と30%移動低下を与える。'},
  ...
  blowdart:{id:'blowdart',mass:.9,name:'吹き矢ゴブリン',short:'吹き矢',role:'超長射程・高速対空',cost:3,hp:240,damage:110,speed:52,range:220,cooldown:.5,radius:12,count:1,air:false,targetsAir:true,projectile:'dart',color:'#8fbd63',desc:'HP240と非常に脆い代わりに、0.5秒ごとに110ダメージを放つ超長射程射手。橋を越えた直後からタワーを狙えるほど長い射程を持ち、地上・空中の両方に対応する。'},
